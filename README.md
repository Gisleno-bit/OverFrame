...
- **Ledge** — 7-frame catch with intangibility you keep if you let go; a ledge someone is holding can't be grabbed (edgehog); **Jump / up** ledge jump (committed), **Attack** ledge attack, **Shield** ledge roll, **toward the stage** getup, **down / away** let go. Everything is slower at 100 %+.
